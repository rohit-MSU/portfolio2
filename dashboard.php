...
<body>
    ...
    <div class="aside-navbar">
        <div class="profile-image">
            ...
            <?php endif; ?>
            <div class="upload-icon" onclick="document.getElementById('profile_image').click()">⇅</div>
    ...
    <div class="main-content">
       <iframe src="carousel.html" frameborder="0" style="height:100vh; width:100%"></iframe>
    </div>
