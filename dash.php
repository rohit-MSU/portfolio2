...
<body>
    ...
    <div class="navbar">
        ...
        <div class="user-info">Welcome, <?php echo htmlspecialchars($user['username']); ?></div> <!-- Replace with dynamic user name -->
    </div>
    ...
    <div class="aside-navbar">
        <div class="profile-image">
            ...
            <p style="color: red;"><?php echo htmlspecialchars($error_message); ?></p> <?php endif; ?>
